...
Here's why 22 is NOT a happy number: 22->8->64->52->29->85->89->145->42->20->
4->16->37->58->89 ...
"""
...
def is_happy(numbers, count=0):
    """Returns True if the supplied number is happy.
    It returns False otherwise. Input number must
    be in string format."""
    digits = []
    number_list = list(str(numbers))
    nums = list(map(int, number_list))
    digits.extend(nums)
    acc = 0
    if count > 20:
        return False
